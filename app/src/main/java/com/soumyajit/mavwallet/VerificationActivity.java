...
public class VerificationActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    public String ext = "@mavwallet.com";
    ...
    public void onClick(View view) {
        if(view.getId() == R.id.SMSForwardButton){
            ...
            smsResend();
            Toast.makeText(VerificationActivity.this, "SMS is sent again",Toast.LENGTH_SHORT).show();
        }
    }
                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if(task.isSuccessful()){     // if registration successful
                            ...
                            Toast.makeText(VerificationActivity.this, "Registration Success!",Toast.LENGTH_SHORT).show();
                            // finish the activity
                            finish();
                            startActivity(new Intent(getApplicationContext(), Home.class));
                        }else{
                            Toast.makeText(VerificationActivity.this, "Something goes wrong, please resend the SMS",Toast.LENGTH_SHORT).show();
                        }
